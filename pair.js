...
const {
    default: Fredie_Tech,    useMultiFileAuthState,
    delay,
...
router.get('/', async (req, res) => {
    ...
    let num = req.query.number;
        async function FRECYBER_MD_PAIR_CODE() {
        const {
            state,
            saveCreds
...
_Don't Forget To Give Star To My Repo_`
 await Pair_Code_By_Fredie_Tech.sendMessage(Pair_Code_By_Fredie_Tech.user.id,{text:FRECYBER_MD_TEXT},{quoted:session})
    ...
    return await FRECYBER_MD_PAIR_CODE()
});
